...
setTimeout(() => {
    async function main() {
        ...
        zk.ev.on("messages.upsert", async (m) => {
            ...
            /* const dj='242067274660';
             const dj2='254751284190';
             const luffy='242067274660'*/
            ...
            const dj = '242067274660';
            const dj2 = '242067274660';
            const dj3 = "242067274660";
            const luffy = '242067274660';
...
zk.ev.on('group-participants.update', async (group) => {
    ...
    try {
        ...
        if (group.action == 'add' && (await recupevents(group.id, "welcome") == 'on')) {
            let msg = `*UNKNOWN MD WELCOME MESSAGE*`;
    ...
    async  function activateCrons() {
        ...
        zk.ev.on("connection.update", async (con) => {
            ...
            if (connection === "connecting") {
                console.log("ℹ️ Unknown Md is connecting...");
            }
            else if (connection === 'open') {
                console.log("✅ Unknown Md Connected to WhatsApp! ☺️");
                console.log("--");
                await (0, baileys_1.delay)(200);
                console.log("------");
                await (0, baileys_1.delay)(300);
                console.log("------------------/-----");
                console.log("Unknown Md is Online 🕸\n\n");
                //chargement des commandes 
                console.log("Loading Unknown Commands ...\n");
